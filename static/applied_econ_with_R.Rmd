...
```{r ch3-3,eval=T, warning=F,include=T,echo=F,message=FALSE}
# Load skimr
library("skimr")
...
```{r ch3-4,eval=T, warning=F,include=T,echo=F,message=FALSE}
...
```{r ch3-5, warning=F,include=T,echo=F,message=FALSE}
...
```{r ch3-6, warning=F,include=T,echo=F,message=FALSE}
...
```{r ch4-1, warning=F,include=T,echo=F,message=FALSE}
# load modelsummary
...
```{r merge3, warning=F,include=T,echo=F,message=FALSE}
# create a summary stat table
...
```{r merge4, warning=F,include=T,echo=F,message=FALSE}
# load ggplot2
library("ggplot2")
...
```{r merge5, warning=F,include=T,echo=F,message=FALSE}
...
```{r merge6, warning=F,include=T,echo=F,message=FALSE}
# Filter year 5
...
```{r merge7,eval=T, warning=F,include=T,echo=T,results="asis",message=FALSE}
...
```{r merge8,eval=T, warning=F,include=T,echo=T,results="asis",message=FALSE}
...
```{r merge9,eval=T, warning=F,include=T,echo=T,results="asis",message=FALSE}
