...
```
```{r ch2-10a,eval=T, warning=F,include=T,echo=F,message=FALSE}
# school_data_merged 
school_data_merged<-merge(school_data_1,school_data_2,by="person_id")
# Merge school_data_3 with school_data_merged
school_data_merged<-merge(school_data_merged,school_data_3,by=c("person_id","school_id"))
...
```{r ch3-7  ,eval=F, message=F,warning=F,include=T,echo=T,  out.width=500,fig.align="center"}
# Install packages (you only have to do this once)
...
```{r ,eval=T, warning=F,include=T,echo=F,message=FALSE}
# Use skim() to skim the data
skim(analysisdata%>%filter(year==5))
```
...
```{r ch5-1,eval=F, warning=F,include=T,echo=T,results="asis",message=FALSE, out.width=400,fig.align="center"}
# install ggplot2
...
```{r ,eval=F, warning=F,include=T,echo=T,results="asis", out.width=600,fig.align="center"}
# Install lfe
...
```{r ch9-2 ,eval=T, warning=F,include=T,echo=F,message=FALSE}
